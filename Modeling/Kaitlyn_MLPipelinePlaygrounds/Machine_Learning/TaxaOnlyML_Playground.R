...
message(sprintf("Train proportion: %.2f | Test proportion: %.2f", train_prop, test_prop))
...
feature_prevalence <- colMeans(train_X > 0) #compute prevalence of each column in TRAIN
