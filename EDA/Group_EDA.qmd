...
-   Potential flow of our EDA section: Data Availability/Selection → Metadata analysis → Taxa/pathway discussions → Data Limitations (What gets cut out after filtering) → Next Steps
