...
g1 <- ggplot(meta_completeness,
  ...
  labs(
    ...
    subtitle = "Percent of samples with non-missing values",
    x = NULL,
    y = NULL
  ) +
  theme_bw() +
...
g2 <- ggplot(
  ...
  theme_bw() +
  labs(
    title = str_wrap("Sequencing Platforms and DNA Extraction Kits Across CRC-Relevant Studies", width = 30),
    x = "Number of samples",
    y = "Study name",
  ...
  theme(
    ...
    axis.text.y = element_text(size = 6),      # study names
...
g2 + g1 +
  plot_layout(
    ...
    title = "Figure 6: Study variations and Data limitations",
    tag_levels = "A",
  ) &
  theme (
