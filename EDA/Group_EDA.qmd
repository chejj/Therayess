...
decade1 <- qualifying_studies %>% 
  ...
  labs(
    subtitle = "Age Distribution By Decade: \nCRC Progression Classifier Spread", 
    x = "Age by Decade")
...
decade2 <- qualifying_studies %>%
  ...
  # Labeling
  #---------
  labs(subtitle = "Proportion of CRC Progression by Age Decade",
       x = "Age By Decade", y = "Proportion") +
  theme(axis.text.x = element_text(
    angle = 30, hjust = 1, lineheight = 1.1), legend.key.size = unit(0.3, "cm"), 
    legend.position = "none"
  )
...
decade3 <- qualifying_studies %>%
  ...
  # Labeling
  #---------
  ggtitle("Distribution of Age, Male") +
...
decade1 + decade2 + decade3 + plot_layout(design = layout, guides = "collect") +
  plot_annotation(
