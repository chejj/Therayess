...
#| label: Age by Gender
# ---
gender.table <- table(qualifying_studies$gender)
...
#####################
country_overall %>% 
  kbl(col.names = c("Country", "CRC Classifier", "n"),
...
## Column Data Missingness Summary

```{r}
#| label: Column Missingness
# ---
overview %>%
  ...
  kbl(
    col.names = c("Index",
                  ...
                  "Unique Values",
                  "Variable Type"),
    caption = "Structural Metadata Summary",
    format = "html"
  ) %>%
