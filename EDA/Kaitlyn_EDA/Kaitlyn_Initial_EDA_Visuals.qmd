...
qualifying_studies %>%   
  ...
  # Labeling   
  #---------   
  ggtitle("Distribution of BMI by CRC Progression") +   
...
qualifying_studies %>%   
  ...
  # Labeling   
  #---------   
  ggtitle("Age by BMI, Colored by CRC Progression Class") +   
  ylab("BMI") +    
  xlab("Age") 
```
...
Note: There are only remarkable values in our `alcohol_numeric` column. The `alcohol` column only contains "no" and "N/A" values and thus was not deemed worthy of further analysis.

```{r}
#| label: Alcohol Analysis: Normality Check
# ---
...
normality3 <- qualifying_studies %>% 
  ...
  # Labeling
  #---------
  ggtitle("QQ Plot of Alcohol (Numeric)")

# Histogram
###########
normality4 <- qualifying_studies %>%
  # Set Up
  # ------
  filter(!is.na(alcohol_numeric)) %>%
  # Plotting
  ...
  xlab("Alcohol (Numeric)")

normality3 / normality4

# QQPlot
########
normality5 <- qualifying_studies %>% 
  # Set Up
  # ------
  filter(!is.na(alcohol_numeric)) %>%
  # Plotting
  ...
  # Labeling
  #---------
  ggtitle("QQ Plot of Log-Transformed Alcohol (Numeric)") +
  

# Histogram
###########
normality6 <- qualifying_studies %>%
  # Set Up
  # ------
  filter(!is.na(alcohol_numeric)) %>%
  # Plotting
  ...
  xlab("Log-Transformed Alcohol (Numeric)")
