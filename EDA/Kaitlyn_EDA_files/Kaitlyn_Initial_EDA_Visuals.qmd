...
qualifying_studies %>%
  ...
  # Labeling
  #---------
  ggtitle("Proportion of Disease by Age Decade") + 
  labs(x = "Age By Decade", y = "Proportion")

```

#### Gender vs. Disease Categories
...
```{r}
#| label: Countries And Disease ProgressionGeographical Barplots
# ---

# Country Barplot: Counts
qualifying_studies %>%
  # Set Up
  # ------
  ...
  ggtitle("Location of Indiviudals (Countries)") +
...
qualifying_studies %>%
  ...
  #---------
  geom_text(stat = "count", aes(label = after_stat(count)), vjust = -0.17, color = "black") +
  ggtitle("Location of Indiviudals (City)") +
  labs(x = "Location (City)", y = "Count")
